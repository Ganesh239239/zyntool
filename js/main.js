const icons = {
  compress: `
    <svg viewBox="0 0 24 24">
      <path d="M4 9h4V5h2v6H4V9zm10-4h6v2h-4v4h-2V5zM8 15H4v-2h6v6H8v-4zm8 0v-6h2v4h4v2h-6z"/>
    </svg>
  `,
  resize: `
    <svg viewBox="0 0 24 24">
      <path d="M3 3h6v2H5v4H3V3zm16 0h2v6h-2V5h-4V3h4zM5 15h4v2H3v-6h2v4zm14-4h2v6h-6v-2h4v-4z"/>
    </svg>
  `,
  crop: `
    <svg viewBox="0 0 24 24">
  ...
  convert: `
    <svg viewBox="0 0 24 24">
      <path d="M12 2l4 4h-3v7h-2V6H8l4-4zm0 20l-4-4h3v-7h2v7h3l-4 4z"/>
    </svg>
  `,
  edit: `
    <svg viewBox="0 0 24 24">
      <path d="M3 17.25V21h3.75L17.8 9.94l-3.75-3.75L3 17.25zM20.7 7.04c.39-.39.39-1.02 0-1.41L18.37 3.3a.9959.9959 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.82-1.84z"/>
    </svg>
  `,
  security: `
    <svg viewBox="0 0 24 24">
