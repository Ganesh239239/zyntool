// Compress IMAGE - COMPRESS MODE
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ compress.js - COMPRESS MODE');
    ...
    function processImage(quality) {
        ...
        document.getElementById('progress-number').textContent = `-${savings}%`;
        document.getElementById('progress-label').textContent = 'File Reduced';
        ...
        document.getElementById('pie-percentage').textContent = `-${savings}%`;
