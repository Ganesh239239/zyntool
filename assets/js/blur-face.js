// Blur face - Unique Logic
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ blur-face.js loaded - BLUR MODE');
    ...
    function processImage(quality) {
        ...
        document.getElementById('progress-indicator').textContent = `${quality}px`;
        document.getElementById('original-size').textContent = 'Clear';
        document.getElementById('compressed-size').textContent = 
            `Blur ${quality}px`;

        updatePieChart(quality, 'blur');
    }
