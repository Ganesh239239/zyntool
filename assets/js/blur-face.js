...
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ blur-face.js - BLUR MODE');
    ...
    function processImage(quality) {
        ...
        document.getElementById('progress-number').textContent = `${quality}px`;
        document.getElementById('progress-label').textContent = 'Blur Radius';
        document.getElementById('original-stat').textContent = 'Clear';
        document.getElementById('processed-stat').textContent = `Blur ${quality}px`;
        document.getElementById('pie-percentage').textContent = `${quality}px`;

        updatePieChart(quality);
    }
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function() {
            if (uploadedFile && uploadedFile.dataUrl) {
                ...
                link.download = 'blur-face_' + uploadedFile.name;
                link.click();
            }
        });
    }
