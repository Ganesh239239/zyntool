// Upscale Image - Unique Logic
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ upscale.js loaded - UPSCALE MODE');
    ...
    function processImage(quality) {
        ...
        document.getElementById('progress-indicator').textContent = `+${scale}%`;
        ...
        document.getElementById('compressed-size').textContent = 
            `${formatFileSize(processedSize)} (${scale}%)`;

        updatePieChart(scale - 100, 'upscale');
    }
