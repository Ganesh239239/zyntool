// Convert from JPG - CONVERT MODE
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ convert-from-jpg.js - CONVERT MODE');
    ...
    function processImage(quality) {
        ...
        document.getElementById('progress-label').textContent = 'Converted';
        ...
        document.getElementById('pie-percentage').textContent = '✓';
