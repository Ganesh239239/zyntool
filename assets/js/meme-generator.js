// Meme generator - Premium Features
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ meme-generator.js loaded');
    ...
    function showPremiumControls() {
        ...
        memeGroup.className = 'control-group';
        memeGroup.innerHTML = `
        ...
        `;
        controlsDiv.appendChild(memeGroup);
    }
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function() {
            ...
            link.download = 'meme-generator_' + Date.now() + '.jpg';
            link.click();
        });
    }
});