// Photo editor - Unique Logic
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ photo-editor.js loaded - EDIT MODE');
    ...
    function processImage(quality) {
        // PHOTO EDITOR: Shows edited
        processedSize = Math.round(originalSize * 1.1);

        document.getElementById('progress-indicator').textContent = '✓ Edited';
    ...
    if (downloadSingleBtn) {
        downloadSingleBtn.addEventListener('click', function() {
            if (uploadedFile && uploadedFile.dataUrl) {
                ...
                link.download = 'photo-editor_' + uploadedFile.name;
                link.click();
            }
        });
    }
